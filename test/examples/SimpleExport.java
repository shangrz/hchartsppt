...
//		pngFromJsonExporter.export (json, null, new File (exportDirectory, "column-basic-from-jsonified-java.png"));
        ...
        HighchartsExporter<String> pptFromJsonExporter = ExportType.ppt.createJsonExporter ();
        pptFromJsonExporter.export (json, null, new File (exportDirectory, "test1.ppt"));
